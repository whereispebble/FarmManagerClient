...
public class HomeController {
    ...
    private void updateUserInfo() {
        try {
            ...
            lblUserName.setText(userDataExists(manager.getName()));
            lblUserEmail.setText(userDataExists(manager.getEmail()));
            lblUserStreet.setText(userDataExists(manager.getStreet()));
            lblUserZip.setText(userDataExists(manager.getZip()));
            lblUserCity.setText(userDataExists(manager.getCity()));
    ...
    /**
     * Start method to initialize the stage. This method is currently not supported.
     *
