...
//    private TableColumn tcAnimalGroup;
    private TableColumn<AnimalBean, String> tcAnimalGroup;
    @FXML
    ...
    private ObservableList<String> animalGroups = FXCollections.observableArrayList("Grupo 1", "Grupo 2", "Grupo 3");
    private ObservableList<String> speciesList = FXCollections.observableArrayList("Especie A", "Especie B", "Especie C");
    private ObservableList<String> subespeciesList = FXCollections.observableArrayList("Subespecie 1", "Subespecie 2", "Subespecie 3");
...
//        seleccionados. Edición ComboBoxTableCell
        ...
        try {         
            ...
            animalList = AnimalManagerFactory.get().getAnimalsByAnimalGroup(new GenericType<List<AnimalBean>>() {}, "Grupo");
