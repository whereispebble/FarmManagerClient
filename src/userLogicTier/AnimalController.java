...
//                    animalList = AnimalManagerFactory.get().getAnimalsByAnimalGroup(new GenericType<List<AnimalBean>>() {}, tfSearch.getText());
                ...
                case "Subespecies":
                    if (tfSearch.getText() != null && !tfSearch.getText().isEmpty()) {
                        animalList = AnimalManagerFactory.get().getAnimalsBySubespecies(new GenericType<List<AnimalBean>>() {
                        }, tfSearch.getText());
                    } else {
                        showAllAnimals();
                    }
                ...
                case "Birthdate":
                    ...
                    if (from != null && to != null) {
                        animalList = AnimalManagerFactory.get().getAnimalsByBirthdate(new GenericType<List<AnimalBean>>() {
                        }, from, to);
                    } else if (from != null) {
                        animalList = AnimalManagerFactory.get().getAnimalsByBirthdateFrom(new GenericType<List<AnimalBean>>() {
                        }, from);
                    } else if (to != null) {
                        animalList = AnimalManagerFactory.get().getAnimalsByBirthdateTo(new GenericType<List<AnimalBean>>() {
                        }, to);
                    } else {
                        showAllAnimals();
                    }
    ...
    private void showAllAnimals() {
        try {
            ...
            List<AnimalBean> allAnimals = AnimalManagerFactory.get().getAllAnimals(new GenericType<List<AnimalBean>>() {
            }, "1");
